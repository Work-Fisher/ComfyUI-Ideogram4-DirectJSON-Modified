...
function injectStyle() {
  if (document.getElementById("wfideo-mod-style")) return;
...
app.registerExtension({
  name: "WorkFisher.Ideogram4DirectJSONModified",

  async beforeRegisterNodeDef(nodeType, nodeData) {
    if (nodeData?.name !== "Ideogram4DirectJSONBuilderModified") return;
    injectStyle();
